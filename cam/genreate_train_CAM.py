...
dataset_path = "./train_all_patches"
...
onlineDataset = dataset.OnlineTrainDataset(dataset_path, transform=transforms.Compose([
...
for im_path, im in tqdm(onlineDataloader):
