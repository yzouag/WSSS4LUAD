...
then
    ...
    CUDA_VISIBLE_DEVICES=0 python pprepare_seg_inputs.py -d 0 -dataset glas -ckpt resnet_glas_11256_best 
...
then
    ...
    CUDA_VISIBLE_DEVICES=0 python pprepare_seg_inputs.py -d 0 -dataset luad -ckpt resnet_luad_22475_best 
